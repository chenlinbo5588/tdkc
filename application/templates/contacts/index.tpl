                ...
                <form action="{url_path('contacts')}" method="get" name="searchform">
                    ...
                    <ul>
                        <li>
                            ...
                            <a class="addlink" href="{url_path('contacts','add')}">添加通讯录</a>
                        </li>
                     </ul>
                </form>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr id="row_{$item['id']}">
                           ...
                           <td>
                               ...
                               <a href="javascript:void(0);" data-title="{$item['name']}" data-href="{url_path('contacts','delete','id=')}{$item['id']}" data-id="{$item['id']}" class="delete">删除</a>
                               {/if}
                            </td>
                        </tr>
                        {foreachelse}
