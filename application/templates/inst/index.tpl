                ...
                <form action="{url_path('inst')}" method="get" name="searchform">
                    ...
                    <ul>
                        <li>
                            ...
                            <a class="addlink" href="{url_path('inst','add')}">添加规章制度</a>
                        </li>
                     </ul>
                </form>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr id="row_{$item['id']}">
                           ...
                           <td><a href="javascript:void(0);" class="item_detail" data-href="{url_path('inst','detail','id=')}{$item['id']}">{$item['title']|escape}</a></td>
                           <td>{$item['status']}</td>
                           <td>{$item['creator']}</td>
                           <td>{$item['createtime']|date_format:"Y-m-d H:i:s"}</td>
                           <td>
                               <a href="{url_path('inst','edit','id=')}{$item['id']}">编辑</a>
                           </td>
                        </tr>
                        {/foreach}
                    </tbody>
