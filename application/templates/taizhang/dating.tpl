                ...
                <table class="table" id="listtable" >
                    ...
                    <tbody>
                        ...
                        <tr id="row_{$item['id']}">
                           ...
                           <td class="col_amount ss_amount" data-amount-name="ss" data-amount-title="实收金额">{if $hasFeeAuth}{$item['ss_amount']}{else}0{/if}</td>
                           <td>{if $item['get_doc'] == 1}已领取{else}未领取{/if}</td>
                           <td>{$item['get_doctime']}</td>
                           <td>{$item['remark']|escape}</td>
                           <td>
                           {if $hasFeeAuth}<a href="javascript:void(0);" class="popwin" data-id="{$item['id']}" data-href="{url_path('taizhang','fee','id=')}{$item['id']}">收费</a>{/if}
                            </td>
                        </tr>
                        {/foreach}
                    </tbody>
