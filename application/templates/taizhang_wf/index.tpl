{include file="common/main_header.tpl"}
            <div class="row-fluid">
                ...
                <form action="{url_path('taizhang_wf')}" method="get" name="searchform">
                    <input type="hidden" value="taizhang_wf" name="{config_item('controller_trigger')}"/>
                    ...
                    <ul>
                        <li>
                            ...
                            {auth name="taizhang_wf+add"}<a href="javascript:void(0);" class="addlink">+新增违法用地台账</a>{/auth}
                        </li>
                     </ul>
                </form>
            </div>
            ...
            <div class="span12">
                ...
                <table class="table" id="listtable" >
                    <thead>
                        <tr>
                            {auth name="taizhang_wf+delete"}<th></th>{/auth}
                            <th>时间</th>
                            <th>总编号</th>
                            <th>分编号</th>
                            <th>单位名称</th>
                    ...
                    <tbody>
                        ...
                        <tr id="row_{$item['id']}">
                           {auth name="taizhang_wf+delete"}<td class="center"><input type="checkbox" name="id[]" value="{$item['id']}"/></td>{/auth}
                           ...
                           <td>
                               {auth name="taizhang_wf+edit"}<a href="javascript:void(0);" class="edit" data-id="{$item['id']}" data-href="{url_path('taizhang_wf','edit','id=')}{$item['id']}">编辑</a>{/auth}
                               {auth name="taizhang_wf+fee"}<a href="javascript:void(0);" class="popwin" data-id="{$item['id']}" data-href="{url_path('taizhang_wf','fee','id=')}{$item['id']}">收费</a>{/auth}
                           </td>
                        </tr>
                        {/foreach}
                    </tbody>
            ...
            <form id="delete_form" name="deleteForm" action="{url_path('taizhang_wf','delete')}" method="post" target="post_iframe">
                <div class="inputlist">
