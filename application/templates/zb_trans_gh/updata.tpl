...
<html>
    ...
    <body>
        <h1 class="title">规划数据转换 第二步 (Step2)</h1>
        ...
        <div class="example">
            <form name="fx" action="{url_path('zb_trans_gh','fx')}" method="get" target="_blank">
                <input type="hidden" value="zb_trans_gh" name="{config_item('controller_trigger')}"/>
