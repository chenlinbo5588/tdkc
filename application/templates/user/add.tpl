            ...
            <div class="row-fluid">
                ...
                {/if}
                    <table class="maintain">
                        <tbody>
                        <tr>
                            <td><label class="required"><em>*</em><strong>姓名</strong></label></td><td><input type="text" name="name" value="{$user['name']}" placeholder="请输入员工姓名"/><span class="tip">{form_error('name')}</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><label class="required"><em>*</em><strong>登陆账号</strong></label></td><td><input type="text" name="account" value="{$user['account']}" placeholder="请输入登陆账号"/><span class="tip">{form_error('account')} 英文字母、数字、下划线、中划线,建议使用姓名拼音的方式,入 王小二 则账号为 wangxiaoer   最大长度15个字符 </span></td>
                        </tr>
                        <tr>
                            <td><label class="required"><em>*</em><strong>工号</strong></label></td><td><input type="text" name="gh" value="{$user['gh']}" placeholder="请输入员工工号"/><span class="tip">{form_error('gh')}</span></td>
                        </tr>
                        {if $action == 'edit'}
                        <tr>
                        ...
                        {/if}
                        <tr>
                            <td><label class="optional"><em></em><strong>身份证号码</strong></label></td><td><input type="text" name="id_card" value="{$user['id_card']}" placeholder="请输入身份证号码"/><span class="tip">{form_error('id_card')}</span></td>
                        </tr>
                        <tr>
                            <td><label class="optional"><em></em><strong>邮箱地址</strong></label></td><td><input type="text" name="email" value="{$user['email']}" placeholder="请输入邮箱地址"/><span class="tip">{form_error('email')}</span></td>
                        </tr>
                        <tr>
                            <td><label class="required"><em>*</em><strong>手机号码</strong></label></td><td><input type="text" name="mobile" value="{$user['mobile']}" placeholder="请输入手机号码"/><span class="tip">{form_error('mobile')}</span></td>
                        </tr>
                        <tr>
                            <td><label class="optional"><em></em><strong>座机号码</strong></label></td><td><input type="text" name="tel" value="{$user['tel']}" placeholder="请输入座机号码"/><span class="tip">{form_error('tel')}</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><label class="optional"><em></em><strong>职称名称</strong></label></td><td><input type="text" name="job_title" value="{$user['job_title']}" placeholder="请输入职称名称"/><span class="tip">{form_error('job_title')}</span></td>
                        </tr>
                        <tr>
                            <td><label class="optional"><em></em><strong>当前岗位名称</strong></label></td><td><input type="text" name="current_job" value="{$user['current_job']}" placeholder="请输入当前岗位名称"/><span class="tip">{form_error('current_job')}</span></td>
                        </tr>
                        <tr>
