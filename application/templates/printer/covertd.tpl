...
<html>
    ...
    <body>
        ...
        <div class="covertd preview">
            <div class="item zi inputarea">{if strtoupper($info['region_code']) == 'A'}浒{else if ($info['region_name'] == '慈东滨海区')}龙{else}{$info['region_name']|cutText:1:''}{/if}</div>
            <div class="item project_no inputarea">{strtoupper($info['project_no'])}</div>
