                    ...
                    <table class="border1" style="table-layout: fixed;">
                        <thead>
                            <tr>
                                ...
                                <td colspan="4"><span class="bh inputarea" >NO( {strtoupper($info['project_no'])} )</span> <span class="word inputarea" > 字 ({if strtoupper($info['region_code']) == 'A'}浒{else if ($info['region_name'] == '慈东滨海区')}龙{else}{$info['region_name']|cutText:1:''}{/if}) </span> <span class="nature">性质: <span class="inputarea">{if $info['nature']}{$info['nature']}{else}请填写性质{/if}</span></span></td>
                            </tr>
                            <tr>
