                    ...
                    {/if}
                        <table class="maintain">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><label class="required"><em>*</em><strong>项目名称</strong></label></td><td><input type="text" style="width:300px" name="name" value="{$info['name']}" placeholder="请输入项目名称"/><span class="tip">{form_error('name')}</span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><label class="required"><em>*</em><strong>出报告时间</strong></label></td><td><input type="text"  name="complete_time" class="Wdate" readonly onclick="WdatePicker()" value="{$info['complete_time']|date_format:"Y-m-d"}" placeholder="出报告时间"/><span class="tip">{form_error('complete_time')}</span></td>
                                </tr>
                                <tr>
